  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case FCPChannelTypes.setRootTemplate:
      ...
      case String(describing: FCPListTemplate.self):
        rootTemplate = FCPListTemplate(
          obj: args["rootTemplate"] as! [String: Any], templateType: FCPListTemplateTypes.DEFAULT)
        break
      default:
        result(false)
        return
    ...
    case FCPChannelTypes.pushTemplate:
      ...
      case String(describing: FCPInformationTemplate.self):
        ...
        break
      case String(describing: FCPListTemplate.self):
        template = FCPListTemplate(
          obj: args["template"] as! [String: Any], templateType: FCPListTemplateTypes.DEFAULT)
        break
      default:
        result(false)
        return
